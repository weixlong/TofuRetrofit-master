...
public class PhotoPickerActivity2 extends PhotoPickerActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.done) {
            ...
            finish();
            TofuBus.get().executePickerMethod(label, selectedPhotos);
            return true;
        }
    ...
    @Override
    public PhotoPickerActivity2 getActivity() {
        return this;
    }
    @Override
