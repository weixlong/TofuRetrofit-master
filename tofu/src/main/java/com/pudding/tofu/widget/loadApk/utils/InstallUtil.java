package com.pudding.tofu.widget.loadApk.utils;
...
import com.pudding.tofu.widget.loadApk.LoadApkProvider;
...
public class InstallUtil {
    ...
    private static void installNormal(Context context, String apkPath) {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.N) {
            ...
            Uri apkUri = LoadApkProvider.getUriForFile(context, "com.tofu.padding", file);
        ...
        Observable.just(apkPath)
                .map(new Function<String, Integer>() {
                    ...
                    public Integer apply(String s) throws Exception {
                        return SystemManager.RootCommand("pm install -r " + s);
                    }
                })
